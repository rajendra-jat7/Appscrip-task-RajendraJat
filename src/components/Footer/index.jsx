...
const Footer = () => {
  ...
  const handlemettamuse = () => {
    ...
    setFooterbtmcls(metta ? "footer-bottom" : "height536");
  };
  ...
  const handleQuicklinks = () => {
    ...
    setFooterbtmcls(quicklinks ? "footer-bottom" : "height536");
  };
  ...
  return (
    <footer id="footer">
      ...
      <div className={footerbtmcls}>
          ...
          <div className={l2class}>
            ...
            {quicklinks && (
              <>
                ...
                <span style={{ margin: "10px 0" }}>Terms & Conditions</span>
              </>
            )}
          </div>
        ...
        <div className="footer-bottom-right">
          <div className="bot-media">
            <div
              className={`footer-followus ${followOpen ? 'open' : ''}`}
      ...
      <div className="copyright">
        Copyright © 2024 Keerthana. All rights reserved.
      </div>
    </footer>
  );
};
